                ...
                <div class="col-xl-8 col-lg-10 col-md-10">
                    ...
                    <div class="card-deck">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                {!! Form::open(['route'=>'new-subcategory', 'method'=>'POST']) !!}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" name="subcategoryDescription" id="subcategoryDescription"  rows="6"></textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="submit" class="btn btn-primary btn-block" name="btn" value="Add Subcategory Info">
                                        </div>
                                    </div>
                                {!! Form::close() !!}
