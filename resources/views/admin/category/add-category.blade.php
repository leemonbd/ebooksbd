                            ...
                            <div class="card-body">
                                <form action="{{route('new-category')}}" method="post">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" id="categoryDescription" name="categoryDescription" rows="6"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="submit" class="btn btn-primary btn-block" name="btn" value="Add Category Info">
                                        </div>
                                    </div>
                                </form>
                            </div>
