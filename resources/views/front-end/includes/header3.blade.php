                                ...
                                <div class="cart-dropdown-block">
                                    ...
                                    <div class=" single-cart-block">
                                        <div class="cart-product">
                                            <a href="#" class="image">
                                                <img src="{{asset($wishlistBook->options->image)}}" alt="" class="img-fluid" height="123" width="80">
                                            </a>
                                            <div class="content">
                                                <h3 class="title">{{$wishlistBook->name}}
                                                </h3>
                                                <p class="price">৳00.00</p>
                                                <p class="price-old">৳{{$wishlistBook->price}}</p>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
                ...
                <div class="col-md-3 col-5  order-md-3 text-right">
                    <div class="mobile-header-btns header-top-widget">
                        <ul class="header-links">
                            <li class="sin-link">
                                <a href="{{route('show-cart')}}" class="cart-link link-icon "><i class="ion-heart"></i>
                                    @php($z=1)
                                    @foreach($wishlistBooks as $wishlistBook)
                                        <span class="text-number">
                                                {{$z++}}
