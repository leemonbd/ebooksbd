...
@section('body2')
    ...
    {{--<script type="text/javascript">
        ...
        sortSelect.onchange=function (){
            var sortShowPage=document.getElementById('sortSelect').value;
            var xmlHttp=new XMLHttpRequest();
            var serverPage='http://localhost/IslamicBookBD/public/ajax-sort-page-check/'+sortShowPage;
